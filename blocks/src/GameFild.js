	...
	GameFild.prototype.reWritefield = function( fieldFigure, iStart, jStart ) {
	...
	GameFild.prototype.insertFigure = function( fieldFigure, iStart, jStart ) {
	...
	GameFild.prototype.delLines = function( numsLine, numsCol ) {
